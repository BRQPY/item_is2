...
urlpatterns = [
    ...
    path('gestionUser/config/', viewsGestionUser.ConfigView, name="ConfigView"),
    ...
    path('fase/roturaLineaBase/listado/proyectoid=<str:proyectoid>/faseid=<str:faseid>/lineaBaseid=<str:lineaBaseid>/',
