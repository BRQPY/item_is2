...
urlpatterns = [
    ...
    path('proyecto/proyectoRol/asignar/proyectoid=<str:proyectoid>/userid=<str:userid>', views.proyectoRolAsignar, name="rolAsignar"),
    path('proyecto/proyectoRol/remove/proyectoid=<str:proyectoid>/userid=<str:userid>', views.proyectoRolRemover, name="rolRemover"),
    ...
    path('fase/FaseProyectoInicializado/faseid=<str:faseid>/proyectoid=<str:proyectoid>/', viewsFase.faseVerProyectoInicializado, name="verFaseItems"),
    path('fase/FaseIniciada/config/', viewsFase.FaseConfigInicializada),
    path('fase/FaseIniciada/addUser/', viewsFase.FaseInicializadaAddUser),
