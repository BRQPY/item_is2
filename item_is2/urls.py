...
urlpatterns = [
    ...
    path('proyecto/proyectoInicializar/proyectoid=<str:proyectoid>/', views.proyectoInicializar, name="proyectoInicializarView"),
    path('proyecto/proyectoCancelar/proyectoid=<str:proyectoid>/', views.proyectoCancelar, name="proyectoCancelarView"),
    ...
    path('proyecto/unable/proyectoid=<str:proyectoid>/', views.proyectoDeshabilitar, name="ProyectoDeshabilitar"),
    ...
    path('item/unable/proyectoid=<str:proyectoid>/faseid=<int:faseid>/itemid=<int:itemid>/', viewsFase.itemDeshabilitar, name="itemDeshabilitarView"),
